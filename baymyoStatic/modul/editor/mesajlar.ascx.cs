...
public partial class modul_editor_mesajlar : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.Page.Title = "Mesajlar - " + Settings.CurrentUser().Adi + " " + Settings.CurrentUser().Soyadi;
    ...
    {
        using (BAYMYO.UI.Web.DataPagers data = new BAYMYO.UI.Web.DataPagers(rptListe, "Mesaj", "GuncellemeTarihi DESC", "YoneticiOnay=1 AND HesapID=@HesapID"))
        {
